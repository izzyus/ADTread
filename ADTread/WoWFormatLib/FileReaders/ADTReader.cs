...
namespace WoWFormatLib.FileReaders
{
    public class ADTReader
    {
        ...
        public void LoadADT(string filename, string wdtfilename, string objfilename, string texfilename, bool loadSecondaryADTs = true, bool filenamesOnly = false, bool localFile = false)
        {
